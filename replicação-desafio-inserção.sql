...
insert into Clients (Fname, Minit, Lname, CPF, Address)
    values('Maria','M','Silva',12346789,'rua silva de prata 29, Carangola - Cidade das flores'),
          ('Matheus','O','Pimentel',987654321,'rua almeda 289, Centro - Cidade das flores'),
...
insert into product (Pname, classification_kids, category, avaliação, size) values
                              ...
                              ('Microfone Vedo - Youtber',False,'Eletrônico','4',null),
...
insert into seller (SocialName, AbsName, CNPJ, CPF, location, contact) values
                        ...
                        ('Kids World',null,456789123654485, null,'São Paulo', 11986557484);
